            ...
            <section class="login_content">
                <form METHOD="POST" enctype="multipart/form-data" action="/userLogin">
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-plus-circle"></i>Bitch Lasagna!</h1>
                            <p>©2016 All Rights Reserved. <br>Bitch Lasagna Privacy and Terms</p>
                        </div>
                    </div>
                </form>
            </section>
            ...
            <section class="login_content">
                <form action="/newUser" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-plus-circle"></i> Bitch Lasagna!</h1>
                            <p>©2016 All Rights Reserved. Bitch Lasagna. Privacy and Terms</p>
                        </div>
                    </div>
                </form>
            </section>
